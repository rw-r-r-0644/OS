...
typedef u32 (*read_type_t)(struct fs_node * node, u32 offset, u32 size, u8 * buffer);
typedef u32	(*write_type_t)(struct fs_node * node, u32 offset, u32 size, u8 * buffer);
typedef void (*open_type_t)(struct fs_node * node, u32 flags);
typedef void (*close_type_t)(struct fs_node * node);
typedef struct dirent * (*readdir_type_t)(struct fs_node * node, u32 index);
